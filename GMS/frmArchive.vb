...
Public Class frmArchive
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Try
            If AllCellsSelected(DataGridView2) = True Then
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        If DCPmembers.Rows.Count > 0 Then
            ...
            DataGridView2.DataSource = DCPmembers
        End If
        DCPmembers.Dispose()
        DCPmembers = Nothing
        SQLiteCon.Close()
    ...
    Private Sub btnSW_Click(sender As Object, e As EventArgs) Handles btnSW.Click
        ...
        Try
            ...
            DataGridView2.DataSource = Nothing
            DataGridView2.DataSource = TableDB
            DataGridView2.ClearSelection()
    ...
    Private Function AllCellsSelected(dgv As DataGridView) As Boolean
        AllCellsSelected = (DataGridView2.SelectedCells.Count = (DataGridView2.RowCount + 1 * DataGridView2.Columns.GetColumnCount(DataGridViewElementStates.Visible)))
    End Function
End Class